...
export default function Cart() {
  const request = localStorage.getItem("feverits")
    ? JSON.parse(localStorage.getItem("feverits") as string)
    : [];
  ...
  return (
    <div className="mygrid gap-8 mt-5">
      {!!request.length == false && (
        <h1 className="text-center text-5xl">No movies</h1>
      )}
