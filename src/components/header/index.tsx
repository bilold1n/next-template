  ...
  return (
    <div className="h-screen w-20 bg-[#0E1420] flex flex-col items-center py-4">
      ...
      <nav className="flex-1 flex flex-col items-center gap-8">
        <button className="h-10 w-10 flex items-center justify-center text-[#475569] hover:text-white">
          <svg
            width="20"
            height="20"
            viewBox="0 0 20 20"
        ...
        <button className="h-10 w-10 flex items-center justify-center text-[#475569] hover:fill-white">
          <svg
            width="20"
            height="20"
            viewBox="0 0 20 20"
